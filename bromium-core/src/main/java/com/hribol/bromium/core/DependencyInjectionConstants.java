...
public class DependencyInjectionConstants {
    ...
    public static final String CONFIGURATION_INPUT_STREAM = "CONFIGURATION_INPUT_STREAM";
    public static final String TEST_CASE_INPUT_STREAM = "TEST_CASE_INPUT_STREAM";
