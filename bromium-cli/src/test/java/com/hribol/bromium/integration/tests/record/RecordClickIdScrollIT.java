...
import static com.hribol.bromium.integration.tests.TestUtils.Pages.CLICK_ID_SCROLL_DEMO_PAGE;

public class RecordClickIdScrollIT extends BaseRecordClickIT {

    public RecordClickIdScrollIT() {
        super(CLICK_ID_SCROLL_DEMO_PAGE, CLICK_CLICK_ID_TEST, By.id(CLICK_ID_TEST));
    }
}
