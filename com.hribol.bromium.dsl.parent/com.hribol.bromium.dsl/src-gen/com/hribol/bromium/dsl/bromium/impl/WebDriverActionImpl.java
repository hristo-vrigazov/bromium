 ...
 * <ul>
 *   <li>{@link com.hribol.bromium.dsl.bromium.impl.WebDriverActionImpl#getParameterNames <em>Parameter Names</em>}</li>
 *   <li>{@link com.hribol.bromium.dsl.bromium.impl.WebDriverActionImpl#getParameterValues <em>Parameter Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WebDriverActionImpl extends MinimalEObjectImpl.Container implements WebDriverAction
{
  ...
  public EList<String> getParameterNames()
  {
    ...
    {
      parameterNames = new EDataTypeEList<String>(String.class, this, BromiumPackage.WEB_DRIVER_ACTION__PARAMETER_NAMES);
    }
  ...
  public EList<ParameterValue> getParameterValues()
  {
    ...
    {
      parameterValues = new EObjectContainmentEList<ParameterValue>(ParameterValue.class, this, BromiumPackage.WEB_DRIVER_ACTION__PARAMETER_VALUES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BromiumPackage.WEB_DRIVER_ACTION__PARAMETER_VALUES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BromiumPackage.WEB_DRIVER_ACTION__PARAMETER_NAMES:
