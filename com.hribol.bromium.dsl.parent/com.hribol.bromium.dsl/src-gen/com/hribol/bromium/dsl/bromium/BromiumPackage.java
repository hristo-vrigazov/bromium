...
public interface BromiumPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link com.hribol.bromium.dsl.bromium.impl.ClickNameImpl <em>Click Name</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.hribol.bromium.dsl.bromium.impl.ClickNameImpl
   * @see com.hribol.bromium.dsl.bromium.impl.BromiumPackageImpl#getClickName()
   * @generated
   */
  int CLICK_NAME = 18;
   ...
   * @ordered
   */
  int CLICK_NAME__PARAMETER_NAMES = WEB_DRIVER_ACTION__PARAMETER_NAMES;
   ...
   * @ordered
   */
  int CLICK_NAME__PARAMETER_VALUES = WEB_DRIVER_ACTION__PARAMETER_VALUES;

  /**
   * The number of structural features of the '<em>Click Name</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int CLICK_NAME_FEATURE_COUNT = WEB_DRIVER_ACTION_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link com.hribol.bromium.dsl.bromium.impl.SelectValueImpl <em>Select Value</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.hribol.bromium.dsl.bromium.impl.SelectValueImpl
   * @see com.hribol.bromium.dsl.bromium.impl.BromiumPackageImpl#getSelectValue()
   * @generated
   */
  int SELECT_VALUE = 19;
   ...
   * @ordered
   */
  int SELECT_VALUE__PARAMETER_NAMES = WEB_DRIVER_ACTION__PARAMETER_NAMES;
   ...
   * @ordered
   */
  int SELECT_VALUE__PARAMETER_VALUES = WEB_DRIVER_ACTION__PARAMETER_VALUES;

  /**
   * The number of structural features of the '<em>Select Value</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SELECT_VALUE_FEATURE_COUNT = WEB_DRIVER_ACTION_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for class '{@link com.hribol.bromium.dsl.bromium.ClickName <em>Click Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Click Name</em>'.
  ...
  /**
   * Returns the meta object for class '{@link com.hribol.bromium.dsl.bromium.SelectValue <em>Select Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Select Value</em>'.
   * @see com.hribol.bromium.dsl.bromium.SelectValue
   * @generated
   */
  EClass getSelectValue();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link com.hribol.bromium.dsl.bromium.impl.ClickNameImpl <em>Click Name</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.hribol.bromium.dsl.bromium.impl.ClickNameImpl
     * @see com.hribol.bromium.dsl.bromium.impl.BromiumPackageImpl#getClickName()
     * @generated
     */
    EClass CLICK_NAME = eINSTANCE.getClickName();

    /**
     * The meta object literal for the '{@link com.hribol.bromium.dsl.bromium.impl.SelectValueImpl <em>Select Value</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.hribol.bromium.dsl.bromium.impl.SelectValueImpl
     * @see com.hribol.bromium.dsl.bromium.impl.BromiumPackageImpl#getSelectValue()
     * @generated
     */
    EClass SELECT_VALUE = eINSTANCE.getSelectValue();
