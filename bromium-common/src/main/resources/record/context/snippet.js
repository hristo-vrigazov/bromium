(function () {
    ...
    CssSelector('#recursive-table', false, context, parametersEnrichmentFunctions, parameters, function (table) {
        CssSelector('div.table', false, table, parametersEnrichmentFunctions, parameters, function (table) {
            CssSelector('li', false, table, parametersEnrichmentFunctions, parameters, function (row) {
                CssSelectorByText('p.rowName', 'rowName', true, row, parametersEnrichmentFunctions, parameters, function (row) {
