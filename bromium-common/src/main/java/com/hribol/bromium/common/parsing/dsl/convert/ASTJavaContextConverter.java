...
public class ASTJavaContextConverter implements ASTNodeConverter<ActionContext, Function<ParameterValues, SearchContextFunction>> {

    @Override
    public Function<ParameterValues, SearchContextFunction> convert(ActionContext actionContext) {
